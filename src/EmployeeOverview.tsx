  ...
  return (
    <div className="p-4">
      <div className="shadow-xl p-8 rounded-lg mt-16 max-w-[70vw] mx-auto">
        <h1 className="text-3xl font-medium text-gray-600 text-center">What is your main goal on <span className="bg-linear-to-r from-blue-500 to-cyan-500 text-transparent bg-clip-text font-bold">Metatalent</span></h1>
        ...
        <div className='flex gap-x-16 mt-16 px-8 justify-center'>
          ...
          <div className='shadow-2xl rounded-xl max-w-90'>
            <img className="w-full rounded-t-xl object-cover" src="/cross-skill.png" alt="Option 2" />
            <div className="p-8">
